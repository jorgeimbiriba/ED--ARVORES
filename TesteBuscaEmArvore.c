...
NODE *remover(NODE *root, int valor) {
    ...
    if (valor < root->data) {
        ...
        // Caso 1: Nó sem filhos - apenas remove o nó
        if (root->left == NULL && root->right == NULL) {
            free(root);
            return NULL;
        }
        // Caso 2: Nó com um filho - substitui o nó pelo filho
        if (root->left == NULL) {
        ...
        // Caso 3: Nó com dois filhos -  substitui o valor pelo menor valor da subarvore direita(ou o maior a esquerda) e remove o no substituto
